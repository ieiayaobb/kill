package com.net.core {
	...
	public dynamic final class Person extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const NAME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("Person.name", "name", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const ID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("Person.id", "id", (2 << 3) | com.netease.protobuf.WireType.VARINT);
